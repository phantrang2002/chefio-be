...
namespace infrastructure.Migrations
{
    ...
    [Migration("20250917092959_AddOrderTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chefio.Domain.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Chefio.Domain.Entities.Table", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Chefio.Domain.Entities.Employee", b =>
                {
                    b.HasOne("Chefio.Domain.Entities.Account", "Account")
                        .WithMany()
            ...
            modelBuilder.Entity("Chefio.Domain.Entities.Order", b =>
                {
                    b.HasOne("Chefio.Domain.Entities.Employee", null)
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Chefio.Domain.Entities.Table", null)
                        .WithMany()
